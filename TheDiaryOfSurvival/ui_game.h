...
"}"));
        ...
        groupBoss = new QGroupBox(game);
        groupBoss->setObjectName(QStringLiteral("groupBoss"));
        groupBoss->setGeometry(QRect(210, 140, 291, 201));
        label_22 = new QLabel(groupBoss);
        label_22->setObjectName(QStringLiteral("label_22"));
        label_22->setGeometry(QRect(80, 55, 111, 51));
        QPalette palette7;
        ...
        groupSkill->setGeometry(QRect(180, 540, 400, 60));
        label_20 = new QLabel(groupSkill);
        label_20->setObjectName(QStringLiteral("label_20"));
        label_20->setGeometry(QRect(120, 20, 31, 21));
        QPalette palette8;
        ...
        label_25 = new QLabel(groupSkill);
        label_25->setObjectName(QStringLiteral("label_25"));
        label_25->setGeometry(QRect(50, 20, 31, 21));
        QPalette palette9;
        palette9.setBrush(QPalette::Active, QPalette::WindowText, brush);
        palette9.setBrush(QPalette::Inactive, QPalette::WindowText, brush);
        palette9.setBrush(QPalette::Disabled, QPalette::WindowText, brush1);
        label_25->setPalette(palette9);
        label_25->setFont(font4);
        btnShowTab_2 = new QPushButton(groupSkill);
        btnShowTab_2->setObjectName(QStringLiteral("btnShowTab_2"));
        btnShowTab_2->setGeometry(QRect(0, 0, 16, 50));
        btnShowTab_2->setFont(font5);
        btnShowTab_2->setFocusPolicy(Qt::NoFocus);
        btnShowTab_2->setStyleSheet(QLatin1String("QPushButton{\n"
"border: 0px;\n"
"color:#FFFFFF;\n"
"background-color: rgb(50, 112, 169);\n"
"}\n"
...
"}"));
    ...
    void retranslateUi(QWidget *game)
    {
        ...
        groupBoss->setTitle(QString());
        label_22->setText(QApplication::translate("game", "Boss\346\235\245\345\225\246\357\274\201", 0));
        groupSkill->setTitle(QString());
        label_20->setText(QApplication::translate("game", "Q", 0));
        label_25->setText(QApplication::translate("game", "\347\251\272\346\240\274", 0));
        btnShowTab_2->setText(QApplication::translate("game", "<", 0));
    } // retranslateUi
