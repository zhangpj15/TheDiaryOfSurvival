...
public:
    ...
    void setupUi(QWidget *info)
    {
        ...
        label_16->setGeometry(QRect(303, 11, 101, 101));
        label_16->setStyleSheet(QStringLiteral("border-image: url(:/type/res/config/ico/BlogLogo.png);"));
        ...
        infoBackground->setGeometry(QRect(0, 4, 411, 321));
...
"}"));
        ...
        infoClose->setGeometry(QRect(290, 290, 111, 31));
        QFont font3;
...
"}"));
    ...
    void retranslateUi(QWidget *info)
    {
        ...
        label_13->setText(QApplication::translate("info", "R", 0));
        ...
        label_5->setText(QApplication::translate("info", "WAD", 0));
        ...
        label_9->setText(QApplication::translate("info", "\347\251\272\346\240\274", 0));
        label_11->setText(QApplication::translate("info", "ESC", 0));
        ...
        infoClose->setText(QApplication::translate("info", "\345\205\263 \351\227\255", 0));
