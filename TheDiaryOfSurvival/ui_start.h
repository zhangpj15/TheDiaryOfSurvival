...
"\n"
"}"));
        btnRanking = new QPushButton(start);
        btnRanking->setObjectName(QStringLiteral("btnRanking"));
        btnRanking->setGeometry(QRect(550, 260, 131, 50));
        btnRanking->setMinimumSize(QSize(0, 0));
        btnRanking->setFont(font1);
        btnRanking->setStyleSheet(QLatin1String("QPushButton{\n"
"border: 0px;\n"
"color:#FFFFFF;\n"
"border-radius: 7px;\n"
"\n"
...
"}"));
    ...
    void retranslateUi(QWidget *start)
    {
        ...
        btnRanking->setText(QApplication::translate("start", "RANKING", Q_NULLPTR));
    } // retranslateUi
