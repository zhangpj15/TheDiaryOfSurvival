...
void Widget::checkButtonClicked(){//检查用户名是否可用
...
void Widget::loginButtonClicked(){//注册功能
...
void Widget::addPerson(const QString name,const QString pw ,const QString sex ,const QString mail ,const QString phone){//向数据库中添加用户信息
...
void Widget::loadButtonClicked(){//登陆功能
    loadwin dialog;
