...
void game::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&game::sig_closeGame)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (game::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&game::sig_death)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (game::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&game::sig_quitgame)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (game::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&game::sig_borngoods)) {
                *result = 3;
                return;
            }
        }
